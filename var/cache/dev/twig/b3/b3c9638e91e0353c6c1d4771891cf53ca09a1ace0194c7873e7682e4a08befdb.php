...
class __TwigTemplate_06232622b55be1c09fd96f81bcc2647f6cf495747cd25db5b2d4031269b5e4d2 extends \Twig\Template
{
    ...
    <table>
        <tbody>
            <tr>
                ...
                <td>";
        // line 8
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["evenement"]) ? $context["evenement"] : $this->getContext($context, "evenement")), "id", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Titre</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        if ($this->getAttribute((isset($context["evenement"]) ? $context["evenement"] : $this->getContext($context, "evenement")), "dateE", [])) {
            echo twig_escape_filter($this->env, twig_date_format_filter($this->env, $this->getAttribute((isset($context["evenement"]) ? $context["evenement"] : $this->getContext($context, "evenement")), "dateE", []), "Y-m-d H:i:s"), "html", null, true);
        }
        echo "</td>
            </tr>
            <tr>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 24
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["evenement"]) ? $context["evenement"] : $this->getContext($context, "evenement")), "description", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["evenement"]) ? $context["evenement"] : $this->getContext($context, "evenement")), "ticket", []), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Tarif</th>
                <td>";
        // line 32
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["evenement"]) ? $context["evenement"] : $this->getContext($context, "evenement")), "tarif", []), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <ul>
        ...
        <li>
            <a href=\"";
        // line 42
        echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("evenement_edit", ["id" => $this->getAttribute((isset($context["evenement"]) ? $context["evenement"] : $this->getContext($context, "evenement")), "id", [])]), "html", null, true);
        echo "\">Edit</a>
        </li>
        <li>
            ";
